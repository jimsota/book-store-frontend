      ...
      <div className="flex-1 overflow-y-auto px-4 py-6 sm:px-6">
       <div className="flex items-start justify-between">
        ...
        onClick={ handleClearCart }
         className="relative -m-2 py-1 px-2 bg-red-500 text-white rounded-md
                      ...
                      overflow-hidden rounded-md border border-gray-200">
                        ...
                        <div className="ml-4 flex flex-1 flex-col">
                            <div>
                                 ...
                                 justify-between text-base font-medium
                                 text-gray-900">
                      <h3>
       ...
       <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
        ...
        <p>Subtotal</p>
         ...
         <div className="mt-6">
          ...
          transparent bg-indigo-600 px-6 py-3 text-base font-medium text-white shadow-sm
           hover:bg-indigo-700"
           >
           Checkout
           </Link>
